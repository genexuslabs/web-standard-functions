...
export const testCases1: Array<[GxDate, string]> = [
  [new GxDate(1891, 8, 28), "09/28/91"],
  [new GxDate(2018, 0, 1), "01/01/18"],
  [new GxDate(2018, 0, 30), "01/30/18"],
  [new GxDate(EMPTY_DATE_VALUE), ""],
  [new GxDate(2018, 0, 31), "01/31/18"]
];

/* Default DMY */
export const testCases2: Array<[GxDate, string]> = [
  [new GxDate(1891, 8, 28), "28/09/91"],
  [new GxDate(2018, 0, 1), "01/01/18"],
  [new GxDate(2018, 0, 30), "30/01/18"],
  [new GxDate(EMPTY_DATE_VALUE), ""],
  [new GxDate(2018, 0, 31), "31/01/18"]
];

/* Default YMD */
export const testCases3: Array<[GxDate, string]> = [
  [new GxDate(1891, 8, 28), "91/09/28"],
  [new GxDate(2018, 0, 1), "18/01/01"],
  [new GxDate(2018, 0, 30), "18/01/30"],
  [new GxDate(EMPTY_DATE_VALUE), ""],
  [new GxDate(2018, 0, 31), "18/01/31"]
];
